...
/*
  ...
  const setPurposeEvents = useEventListener(readContracts, "HackathonMunon", "SetPurpose", localProvider, 1);

  ~ Features ~

  - Provide readContracts by loading contracts (see more on ContractLoader.js)
  - Specify the name of the contract, in this case it is "HackathonMunon"
